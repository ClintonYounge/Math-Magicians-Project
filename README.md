...
- Navigate through 3 pages. A home page, a calculator page, and a quote page.
...
`git clone git remote add origin https://github.com/ClintonYounge/Math-Magicians-Project`

or

`git clone git remote add origin https://github.com/ClintonYounge/Math-Magicians-Project` <-- _Only if you have [SSH keys configured](https://docs.github.com/en/authentication/connecting-to-github-with-ssh/adding-a-new-ssh-key-to-your-github-account) on your GitHub account_.
